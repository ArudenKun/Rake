...
public abstract class AbstractJsonPersistence
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="AbstractJsonPersistence" />.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    protected AbstractJsonPersistence(string filePath, JsonSerializerOptions jsonOptions)
    {
        _filePath = filePath;
    ...
    /// Initializes an instance of <see cref="AbstractJsonPersistence" />.
    /// </summary>
    protected AbstractJsonPersistence(string filePath, IJsonTypeInfoResolver jsonTypeInfoResolver)
        : this(
            filePath,
    ...
    protected AbstractJsonPersistence(string filePath)
