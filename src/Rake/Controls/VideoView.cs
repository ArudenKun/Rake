...
// 	{
// 		if (_floatingContent == null || _floatingContent.IsVisible == show) return;
// 		if (VisualRoot is not (Window window and not null)) return;
// 		if(show && _isAttached)
...
// 		else if(RuntimeInformation.IsOSPlatform(OSPlatform.OSX)) player.NsObject = platformHandle.Handle;
// 	}
// }