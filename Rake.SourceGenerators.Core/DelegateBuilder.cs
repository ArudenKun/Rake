...
public sealed class DelegateBuilder : BuilderBase<DelegateBuilder>, IParameterized<DelegateBuilder>
{
    ...
    private readonly List<ParameterBuilder<DelegateBuilder>> _parameters = [];
    ...
    List<ParameterBuilder<DelegateBuilder>> IParameterized<DelegateBuilder>.Parameters =>
        _parameters;
    ...
    public DelegateBuilder AddGeneric(string name) => AddGeneric(name, _ => { });
