    ...
    where T : BuilderBase<T>
{
    ...
    public ParameterBuilder<T> WithDefaultValue() => WithDefaultValue("default");
    ...
    public ParameterBuilder<T> WithDefaultValue(object? value) => WithDefaultValue($"{value}");

    public ParameterBuilder<T> WithNullDefault() => WithDefaultValue("null");
    ...
    {
        return obj != null
            && obj is ParameterBuilder<T> builder
            && builder.Type == Type
            && builder.Name == Name;
    }
