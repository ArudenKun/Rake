...
public static class ICodeWriterExtensions
{
    ...
    )
    {
        ...
        return new ExpressionBlockBuilder(
            writer,
            $"for ({incrementerName} = {counterStart}; {condition}; {incrementerName}{incrementerType}"
        );
    }
    ...
    public static ExpressionBlockBuilder ForEach(
        this ICodeWriter writer,
        string parameter,
        string collection
    )
    ...
    public static ICodeWriter AppendLines<T>(
        this ICodeWriter writer,
    ...
    public static ICodeWriter AppendLines<TKey, TValue>(
        this ICodeWriter writer,
        Dictionary<TKey, TValue> collection,
        Func<TKey, TValue, string> predicate
    )
    {
