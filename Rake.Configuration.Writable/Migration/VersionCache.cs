...
namespace Rake.Configuration.Writable.Migration;
...
{
    private static readonly ConcurrentDictionary<Type, int> InternalCache = new();
    ...
    {
        return InternalCache.GetOrAdd(typeof(T), _ => new T().Version);
    }
